...
<head>
    ...
    <title>Admin page | Resto app</title>
    ...
    <div class="container">
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                ...
                <div class="float-end mt-4 m-4">User : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['user'] ?></a></div>
                    ...
                    <?php
                        ...
                        switch ($level) {
                            case 'admin':
                                ...
                                <li class="nav-item"><a class="nav-link" href="?f=pelanggan&m=select">Customer</a></li>
